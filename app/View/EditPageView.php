    ...
    <div class="mx-auto mb-10 max-w-7xl py-6 sm:px-6 lg:px-8">
        <form class="max-w-sm mx-auto" method="post" action="">
            <div class="mb-5">
                ...
                <input type="text" id="email" value="<?= $old_data['note_name'] ?? htmlspecialchars($userInput['note_name'] ?? '')?>" name="newTitle"
            ...
            <div class="mb-5">
                <label for="message"
                    ...
                    text</label>
                <textarea id="message" name="newContent" rows="4"
                          class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                          placeholder="<?= $old_data['text'] ?? htmlspecialchars($userInput['text'] ?? '')?>"></textarea>
            </div>
            <button type="submit"
